...
| Claude Code | Sign up for a Claude account (use https://claude.ai/referral/4tieocI5Xw for a Claude Max pass — 3 lifetime passes from the maintainer — or https://claude.ai directly), then install the CLI per https://docs.claude.com/en/docs/claude-code/installation | same |
