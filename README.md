...
| **Agent-skills skills** (~12 routinely used) | The 12 skills the workspace auto-invokes during the build phase: `api-and-interface-design`, `ci-cd-and-automation`, `code-review-and-quality`, `debugging-and-error-recovery`, `documentation-and-adrs`, `frontend-ui-engineering`, `git-workflow-and-versioning`, `incremental-implementation`, `security-and-hardening`, `shipping-and-launch`, `spec-driven-development`, `test-driven-development`. All 23 from agent-skills are vendored under `.claude/skills/`; the remaining 11 (`code-simplification`, `context-engineering`, `deprecation-and-migration`, `doubt-driven-development`, `idea-refine`, `interview-me`, `performance-optimization`, `planning-and-task-breakdown`, `source-driven-development`, `using-agent-skills`, `browser-testing-with-devtools`) fire situationally when the context matches or the user asks — same upstream credit. | Vendored into `.claude/skills/`; re-sync via `scripts/update-agent-skills.sh`. |
